...
if __name__=="__main__":
    ...
    task_save_path = '../data/context'
    huggingface_user_name='nayohan'
    dataset_names=["conversation_chronicles"]
    task_list = ["MT_DG", "MT_DS", "MT_DHG", "MT_SRE", "MT_DG_SFT", "MT"]
    # task_list =["MT_DG_SFT", "MT"]
    multi_sessoin_task_list = ["MS_DG", "MS_DS", "MS_DHG", "MS_TIE","MS_DG_SFT", "MS"]
    # multi_sessoin_task_list = ["MS_DG_SFT", "MS"]

    # ## Download dialogue datasets.
    # os.makedirs(download_path, exist_ok=True)
    # save_to_local_disk(download_path)

    # ## Preprocess dialogue datset to same struture
    ...
    ## Generate Multi-turn dialouge related instruction tasks. It's only generate last dataset_name task.
